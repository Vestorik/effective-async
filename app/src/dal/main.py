...
from app.src.dal.cache.cache_manager import create_cache_manager_from_config, CacheManager, CachedUnitOfWork
...
class DataManager:
    ...
    async def close(self) -> None:
        ...
        try:
            ...
            logger.warning("Ошибка при закрытии движка БД: %s", type(ex).__name__, exc_info=True)
